...
class SummarizationModel(object):
    ...
    def _add_placeholders(self):
        ...
        W = tf.Variable(tf.constant(0.0, shape=[self._vocab.size(), hps.emb_dim]),
                        trainable=False, name="W")
        self.embedding_paceholder = tf.placeholder(tf.float32, [self._vocab.size(), hps.emb_dim])
